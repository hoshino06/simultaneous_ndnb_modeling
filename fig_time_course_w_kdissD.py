...
from modules.model_cyclic     import PostSynapticModel 
from minimized_parameters_cyclic_w_kdissD import parameters, k_dissD, KD1, KD2

parameters['k_dissD1'] = k_dissD[NMBD][0]
parameters['k_dissD2'] = k_dissD[NMBD][1]
parameters['k_assocD1'] = k_dissD[NMBD][0]/KD1[NMBD]
parameters['k_assocD2'] = k_dissD[NMBD][1]/KD2[NMBD]
...
plt.savefig('fig_cyclic/time_course_kdissD.pdf', bbox_inches="tight")
plt.show()
...
# Reciprocal model 
from modules.model_reciprocal import PostSynapticModel
from minimized_parameters_reciprocal_w_kdissD import parameters, k_dissD, KD1, KD2
...
plt.yticks(fontsize=15)
plt.tick_params(direction='inout', width=1, length=8)
plt.savefig('fig_reciprocal/time_course_kdissD.pdf', bbox_inches="tight")
