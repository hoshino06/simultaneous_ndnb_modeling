...
def fun(x, log_file=None, param_file=None):
    ...
    if MODEL_TYPE == 'Cyclic':
        k_assocA_ast = 10**x[15] #k_assocA
        k_dissA_ast  = 10**x[16] #k_dissA
    ...
    for NMBD in ['Cisatracurium', 'Vecuronium', 'Rocuronium']:
        ...
        log += f'{NMBD}: \n'
        log += f'KD1={KD1[NMBD]:.2e}, KD2={KD2[NMBD]:.2e}, kdissD={k_dissD[NMBD]:.1f}, mu={KD2[NMBD]/KD1[NMBD]:.4f} \n'

        # パラメータ
        parameters = {
            # kinetic parameters
            'k_dissD1' : k_dissD[NMBD],  #[1/s]
            'k_dissD2' : k_dissD[NMBD],  #[1/s]
            'k_assocD1': k_dissD[NMBD]/KD1[NMBD], #[1/Ms]
            'k_assocD2': k_dissD[NMBD]/KD2[NMBD], #[1/Ms]
...
if __name__ == "__main__":
    ...
    x0 = [ 
            ...
            np.log10(1.0), np.log10(1.0), np.log10(500),       # k_diss 
    ...
    # ログの開始
    log_file = f"minimization_{MODEL_TYPE.lower()}.log" 
    ...
    res_file = f"minimized_parameters_{MODEL_TYPE.lower()}.py"
